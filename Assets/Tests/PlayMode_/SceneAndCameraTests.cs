...
public class SceneAndCameraTests
{
    ...
    [UnityTest]
    public IEnumerator Scene_Has_EventSystem_If_Uses_UI()
    {
        var es = Object.FindObjectOfType<EventSystem>();
        if (es == null) Assert.Ignore("No EventSystem in scene; skipping UI check.");

        Assert.IsTrue(es.gameObject.activeInHierarchy, "EventSystem is inactive.");
        yield return null;
    }
}
